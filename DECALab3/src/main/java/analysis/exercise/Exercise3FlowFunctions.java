                ...
                if (callSiteStmt instanceof InvokeStmt) {
                    ...
                    for (int i = 0; i < invoke.getArgCount(); i++) {
                        ...
                        if (v.equals(fact.getVariable())) {
                            taintedParams.add(i);
                        } else if (fact.toString().startsWith(v.toString() + " <")) {
                            Local l = m.getActiveBody().getParameterLocal(i);
                            String str = fact.toString();
                            int index = str.indexOf(" <");
                            str = str.substring(index + 2);
                            String newParam = l.getName().toString() + " <";
                            str = newParam + str;
                            out.add(new DataFlowFact(new JimpleLocal(str, null)));
                        }
                    }
                        ...
                        if (call.toString().contains("getParameter(")) {
                            ...
                            if (assign.getLeftOp() instanceof Local) {
                                ...
                                if (assign.getLeftOp() instanceof FieldRef) {
                                    ...
                                    out.add(new DataFlowFact(new JimpleLocal(left.toString().replace(".<", " <"), null)));
                                }
                            }
                        }
                    }
                ...
                if (call instanceof Stmt && call.toString().contains("executeQuery")) {
                    ...
                    if (val.getVariable().equals(arg)) {
                        ...
                        if (arg instanceof FieldRef) {
                            ...
                            if (val.toString().equals(ref.toString())) {
                                reporter.reportVulnerability();
                            }
                        }
                    }
        ...
        if (callSiteStmt instanceof AssignStmt && callSiteStmt.toString().contains("java.lang.StringBuilder append(")
            ...
            if (fact.getVariable().equals(arg0) || fact.getVariable().equals(base)) {
                ...
                if (leftOp instanceof Local) {
                    ...
                    out.add(new DataFlowFact(new JimpleLocal(ref.toString().replace(".<", " <"), null)));
                }
            }
        }
                ...
                if (curr instanceof AssignStmt) {
                    ...
                    if (ass.getRightOp() instanceof Local) {
                        ...
                        if (ass.getRightOp() instanceof FieldRef) {
                            ...
                            SootField sootField = (SootField) rightLocal.getField();

                            rightVariable = new DataFlowFact(new JimpleLocal(rightLocal.toString().replace(".<", " <"), null));
...
//                            System.out.println("test: " + leftField.getField());
                            leftVariable = new DataFlowFact(new JimpleLocal(leftField.toString().replace(".<", " <"), null));
                        } else {
